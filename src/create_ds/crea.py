...
#skip = int(sys.argv[3])
i = 0
for src in os.listdir("../dataset"):#extract the file in this 
	if src == "aereo.csv" or src == "amz_new.csv" or src == "electionUS.csv" or src == "elezioniAU.csv" or src == "medici.csv":
		source_f = open(src, 'r')
